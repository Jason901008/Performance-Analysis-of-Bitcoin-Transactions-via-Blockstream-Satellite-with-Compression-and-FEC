...
class dvbs2_fec_ber(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, bitrate=10000000, frame_size='normal', modcod='QPSK1/4', snr=10):
        ...
        self._esn0_db_range = Range(-3, 10, 0.1, snr, 200)
        ...
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 8100, "packet_len")
        self.blocks_rotator_cc_foffset_sim_0 = blocks.rotator_cc(0.00000001, False)
        ...
        self.analog_noise_source_x_0_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 0.8, 0)
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.dvbs2rx_xfecframe_demapper_cb_0, 0))
        ...
        self.connect((self.blocks_file_source_0_0_0_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.blocks_file_source_0_0_0_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.blocks_file_source_0_0_0_0, 0), (self.fec_ber_bf_0, 0))
        self.connect((self.blocks_rotator_cc_foffset_sim_0, 0), (self.blocks_add_xx_0_0, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.dtv_dvb_bch_bb_0, 0))
        ...
        self.connect((self.dtv_dvbs2_modulator_bc_0, 0), (self.blocks_rotator_cc_foffset_sim_0, 0))
        self.connect((self.dvbs2rx_bch_decoder_bb_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.dvbs2rx_bch_decoder_bb_0, 0), (self.blocks_file_sink_0_0_0_2_0, 0))
        self.connect((self.dvbs2rx_bch_decoder_bb_0, 0), (self.fec_ber_bf_0, 1))
